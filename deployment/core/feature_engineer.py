...
class FeatureEngineer:
    """
        ...
        Transforms raw data into ML-ready features including:
        ...
        Args:
            ...
            threshold_percentile (int): Threshold for target classification
    ...
    def _finalize_dataframe(self, df):
        ...
        # Feature cols without tarher and returns
